...
import css from './CalcPage11.module.css'
...
const CalcPage11 = () => {
    ...
    const { priceMax,priceMin,workMin,workMax,page11,setPage11,disign0, setDisign0,disign1, setDisign1,
        ...
        disignPriceUniq,logoPrice,logoDisign, setlogoDisign,firmStylePrice,firmStyle,setFirmStyle,setPage12,setLending} = useContext(MyContext); 
            ...
            <div className={css.nestedContainer1}>
                ...
                <div className={css.tzContainer}>
                    ...
                    <div className={css.tz}>
                        ...
                        <span className={css.tzText}>Шаблонный дизайн с доработкой<li>2 500руб.</li></span>
                    </div>  
                    <div className={css.tz}>
                        {disignApple?
                        ...
                        <span className={css.tzText}>Уникальный современный дизайн в стиле Apple<li>7 500руб.</li></span>
                    </div>  
                    <div className={css.tz}>
                        {disignUniq?
                        ...
                        <span className={css.tzText}>Художественный дизайн с прорисовками<li>15 000руб.</li></span>
                    </div>  
                    <div className={css.tz}>
                        {logoDisign?
                        ...
                        <span className={css.tzText}>Профессиональная разработка логотипа (3 варианта)<li>2 500руб.</li></span>
                    </div>  
                    <div className={css.tz}>
                        {firmStyle?
                        ...
                        <span className={css.tzText}>Разработка фирменного стиля<li>10 000руб.</li></span>
                    </div>  
                    <div className={css.progressBarContainer}>
                    <motion.div initial={{width:'30%'}} whileInView={{width:'60%'}} transition={{duration:1}} className={css.progress}></motion.div>
                    </div>
                </div>
