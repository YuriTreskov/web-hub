...
import css from './CalcPage1Mobile.module.css'
...
const CalcPage1Mobile = () => {
    ...
    const { tz,setTz,priceMax, setPriceMax ,priceMin,setPriceMin,workMin,setWorkMin,
        ...
        setHostingPtice,setServerPrice,hostingPriceSum,serverPriceSum,setInputNumber} = useContext(MyContext); 
            ...
            <div className={css.nestedContainer1}>
                ...
                <div className={css.tzContainer}>
                    ...
                    <div className={css.tz}>
                        ...
                        <div className={css.cardPrice}>5 000 руб.</div>
                    </div>  
                    <div className={`${css.tz}`}>
...
export default CalcPage1Mobile;
