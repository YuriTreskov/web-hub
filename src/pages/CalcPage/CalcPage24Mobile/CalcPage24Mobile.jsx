...
import css from './CalcPage24Mobile.module.css'
                ...
                {countPage>1?<div className={css.tz}>
                        ...
                        {api?<div className={css.tz}>
                            ...
                            {basket?<div className={css.tz}>
                                ...
                                <div className={css.cardPrice}>{basket}руб.</div>
                            </div>:<></>}
...
export default CalcPage24Mobile;
