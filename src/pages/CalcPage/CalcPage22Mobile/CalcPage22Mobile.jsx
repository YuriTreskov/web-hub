...
import css from './CalcPage22Mobile.module.css'
...
const CalcPage22Mobile = () => {
    ...
    const {tz, priceMax,priceMin,workMin,workMax,page12,setPage12,
        ...
        bot,setBot,calc,setCalc,pay,setPay,setStaticDev,setPage11,page22,setPage22,setPage21,setPage23} = useContext(MyContext); 
            ...
            <div className={css.nestedContainer2}>
                ...
                <div className={css.consoleContainer}>
                    <div className={css.progressBarContainer}>
                        <motion.div initial={{width:'50%'}} whileInView={{width:'70%'}} transition={{duration:1}} className={css.progress}></motion.div>
                    </div>
...
export default CalcPage22Mobile;
