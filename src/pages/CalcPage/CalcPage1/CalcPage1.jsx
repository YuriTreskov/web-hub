...
import css from './CalcPage1.module.css'
...
const CalcPage1 = () => {
    ...
    const { tz,setTz,priceMax, setPriceMax ,priceMin,setPriceMin,workMin,setWorkMin,
        workMax,setWorkMax,projectTehnicZadan,semanticYadro,landing ,setLending,
        setCorp,setShop,setPage1,countPage, setCountPage,semantic,setSemantic,
        semanticCount,setSemanticCount,setPage11, setDisign0, setDisign1,setDisign2, setDisignApple, setDisignUniq,setlogoDisign,setFirmStyle,
        setPage13,setadAptiveDev,setadInteractiveDev,setForm ,setBot,setCalc,setPay,setStaticDev,setNumber,
        setHostingPtice,setServerPrice,hostingPriceSum,serverPriceSum} = useContext(MyContext); 

        landing&&setHostingPtice(hostingPriceSum *landing)
        landing&&setServerPrice(serverPriceSum * landing)
    const gsapNext = ()=>{
        setPage11(true)
            ...
            <div className={css.nestedContainer1}>
                ...
                <div className={css.tzContainer}>
                    <div className={css.tz}>
                        ...
                        :
                        <img className={css.tzImg} onClick={()=>{setTz(projectTehnicZadan)}}  src={tzOn} alt="" />
                        }
                    ...
                    <div className={css.tz}>
                        ...
                        :
                        <img className={css.tzImg} onClick={()=>{setTz(projectTehnicZadan)}}  src={tzOff} alt="" />
                        }
                        <span className={css.tzText}>Требуется разработка технического задания<li>5 000руб.</li></span>
                    </div>  
                    <div className={`${css.tz} ${css.count}`}>
                        ...
                        <div className={css.countPageContainer}>{countPage} </div>
