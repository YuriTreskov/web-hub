import css from './ShopPage4.module.css'
...
<section className={css.container}>
    <motion.h2  initial={{y:100}} whileInView={{y:0}} viewport={{amount:.7}}  className={css.header}>Что входит в разработку <span>интернет-магазина</span></motion.h2>
