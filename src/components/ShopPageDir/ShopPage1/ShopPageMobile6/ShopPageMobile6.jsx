...
<section className={css.container}>
    ...
    <motion.img initial={{scale:0.7}} whileInView={{scale:1}} viewport={{amount:.7}} className={css.fon} src={fon} alt="Продвижение интернет-магазина игрушек в социальных сетях" />
    ...
    <h2 className={css.cardHeader}>Контакты</h2>
        ...
        <a onClick={()=>{setModal(true)}} className={css.number} >Заказать Магазин</a>
    </motion.div>
...
export default ShopPageMobile6;