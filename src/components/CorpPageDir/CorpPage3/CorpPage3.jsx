import css from './CorpPage3.module.css'
...
<section className={css.container}>
    ...
    <motion.img initial={{x:100,scale:0.7}} whileInView={{x:0,scale:1}} viewport={{amount:.7}} className={css.img} src={landing} alt="Интерактивная презентация корпоративных услуг" />
</section>
</>
     );
}
 
export default CorpPage3;