import css from './CorpPageMobile2.module.css'
...
const CorpPageMobile2 = () => {
    return (  
<section className={css.container}>
    <img className={css.fon} src={reactive} alt={lst[1].alt} />
    ...
    <motion.div initial={{x:0}} whileInView={{x:0}} viewport={{amount:.7}} className={css.nestedContainer}>
        ...
        <div className={css.imgContainers}>
            ...
            <div className={css.contentContainer}>
                <motion.div initial={{opacity:0}} whileInView={{opacity:.9}} transition={{duration:1}} className={css.cardHeader}>{lst[2].title}</motion.div>
                <motion.div initial={{opacity:0}} whileInView={{opacity:.8}} transition={{duration:1}} className={css.cardFullText}>
                {lst[2].description}
                </motion.div>
            </div>
...
export default CorpPageMobile2;