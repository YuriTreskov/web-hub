import css from './CorpPage6.module.css'
...
<section className={css.container}>
    ...
    <motion.img initial={{x:-100,scale:0.7}} whileInView={{x:0,scale:1}} viewport={{amount:.7}} className={css.fon} src={fon} alt="Презентация нового проекта командой разработчиков" />
