import css from './CorpPage4.module.css'
...
<section className={css.container}>
    <motion.h2  initial={{y:100}} whileInView={{y:0}} viewport={{amount:.7}}  className={css.header}>Что входит в разработку <span>Корпоративного сайта</span></motion.h2>
