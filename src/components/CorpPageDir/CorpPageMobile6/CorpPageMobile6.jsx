...
<section className={css.container}>
    ...
    <motion.img initial={{scale:0.7}} whileInView={{scale:1}} viewport={{amount:.7}} className={css.fon} src={fon} alt="Презентация нового проекта командой разработчиков" />
    ...
    <h2 className={css.cardHeader}>Контакты</h2>
        ...
        <a onClick={()=>{setModal(true)}} className={css.number} >Заказать Сайт</a>
    </motion.div>
...
export default CorpPageMobile6;