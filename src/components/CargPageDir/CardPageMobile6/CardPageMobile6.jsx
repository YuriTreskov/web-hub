...
<section className={css.container}>
    ...
    <motion.img initial={{scale:0.7}} whileInView={{scale:1}} viewport={{amount:.7}} className={css.fon} src={fon} alt="" />
    ...
    <h2 className={css.cardHeader}>Контакты</h2>
        ...
        <a onClick={()=>{setModal(true)}} className={css.number} >Заказать Проект</a>
    </motion.div>
...
export default CardPageMobile6;