import css from './CardPageMobile4.module.css'
...
const CardPageMobile4 = () => {
    return ( 
<>
<section className={css.container}>
    <motion.h2  initial={{y:100}} whileInView={{y:0}} viewport={{amount:.7, once:true}}  className={css.header}>Что входит в разработку <span className={css.span}>индивидуального проекта</span></motion.h2>
...
export default CardPageMobile4;