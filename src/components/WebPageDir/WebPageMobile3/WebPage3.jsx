...
},
{
    ...
    'description':'Cайты на React могут быть эффективно интегрированы с инструментами веб-аналитики и маркетинга, что обеспечивает лучшее понимание пользовательского поведения и повышение конверсии.',
    'img':seo,
...
const WebPage3 = () => {
    ...
    useEffect(() => {
        gsap.to('.fixed-img', {position: 'fixed', top: '20%', left: '0%', transform: 'translate(-50%, -50%)' ,duration:0});
        function handleScroll() {
            const currentY = scrollY.get();
            if (currentY > 4500 && currentY < 8300) {
                // Зафиксируем изображение по центру экрана
                document.body.style.overflow = 'hidden';
                gsap.to('.fixed-img',{opacity:.2})
