...
<section className={css.container}>
    <motion.img initial={{ opacity:0,x:-100 }}   whileInView={{ opacity:1,x:0}} transition={{duration:.5,ease: "easeOut"}} className={css.fon} src={img1} alt="Создание сайта под ключ с индивидуальным дизайном" />
