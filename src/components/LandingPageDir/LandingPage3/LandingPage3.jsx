import css from './LandingPage3.module.css'
...
<section className={css.container}>
    ...
    <motion.img initial={{x:100,scale:0.7}} whileInView={{x:0,scale:1}} viewport={{amount:.7}} className={css.img} src={landing} alt="Создание профессионального веб-сайта под ключ" />
</section>
</>
     );
}
