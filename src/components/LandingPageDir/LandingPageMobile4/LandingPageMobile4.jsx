import css from './LandingPageMobile4.module.css'
...
const LandingPageMobile4 = () => {
    return ( 
<>
<section className={css.container}>
    <motion.h2  initial={{y:100}} whileInView={{y:0}} viewport={{amount:.7, once:true}}  className={css.header}>Особенности разработки <span>landing page</span></motion.h2>
    ...
    <motion.div initial={{x:-100}} whileInView={{x:0}} className={css.card}>
    <div className={css.imgContainer}>
                <motion.img initial={{opacity:0}} whileInView={{opacity:1}} viewport={{amount:.7}} transition={{duration:1}} className={css.img} src={img4} alt="За кулисами веб-разработки: детальный вид на код HTML и CSS, используемый для создания адаптивного лендинга." />
    </div>
            <div className={css.contentContainer}>
        ...
        <motion.div initial={{x:100}} whileInView={{x:0}} className={css.card}>
        <div className={css.imgContainer}>
                <motion.img initial={{opacity:0}} whileInView={{opacity:1}} viewport={{amount:.7}} transition={{duration:1}} className={css.img} src={img5} alt="Стратегия и анализ: маркетолог вглядывается в SEO-метрики для оптимизации эффективности лендинг пейдж." />
        </div>
            <div className={css.contentContainer}>
        ...
        <motion.div initial={{x:-100}} whileInView={{x:0}} className={css.card}>
        <div className={css.imgContainer}>
                <motion.img initial={{opacity:0}} whileInView={{opacity:1}} viewport={{amount:.7}} transition={{duration:1}} className={css.img} src={img6} alt="Концентрация и творчество: веб-дизайнер разрабатывает уникальный макет лендинга в Figma, подчеркивая инновационный подход к визуальной презентации." />
        </div>
            <div className={css.contentContainer}>
...
export default LandingPageMobile4;