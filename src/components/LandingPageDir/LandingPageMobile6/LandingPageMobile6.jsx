...
<section className={css.container}>
    ...
    <motion.img initial={{scale:0.7}} whileInView={{scale:1}} viewport={{amount:.7}} className={css.fon} src={fon} alt="На фотографии - команда маркетологов, работающих над SEO-оптимизацией и продвижением лендинг пейдж для увеличения вовлеченности аудитории." />
    
    <motion.div initial={{ y:10 }} viewport={{amount:.7}}  whileInView={{ x:0 }} className={css.buttonContainer}>
...
export default LandingPageMobile6;